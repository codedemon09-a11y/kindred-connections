    ...
    extend: {
      ...
      colors: {
        ...
        document: {
          ...
          "header-foreground": "hsl(var(--document-header-foreground))",
        },
        table: {
      ...
      boxShadow: {
        ...
        "glow-lg": "0 0 60px hsla(217, 91%, 60%, 0.4)",
        "document": "0 25px 50px -12px hsla(0, 0%, 0%, 0.5)",
        "document-lg": "0 35px 60px -15px hsla(0, 0%, 0%, 0.6)",
        "inner-glow": "inset 0 0 20px hsla(217, 91%, 60%, 0.1)",
      },
      backgroundImage: {
        "gradient-radial": "radial-gradient(var(--tw-gradient-stops))",
        "gradient-conic": "conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))",
        "glass": "linear-gradient(135deg, hsla(0, 0%, 100%, 0.1) 0%, hsla(0, 0%, 100%, 0.02) 100%)",
        "shine": "linear-gradient(135deg, hsla(217, 91%, 60%, 0.3) 0%, hsla(265, 89%, 66%, 0.1) 50%, transparent 100%)",
      },
