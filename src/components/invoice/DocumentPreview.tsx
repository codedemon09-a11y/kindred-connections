...
import { Document, CompanySettings, DocumentType } from '@/types/invoice';
    ...
    return (
      <div ref={ref} className="print-professional">
        ...
        <div className="print-title-bar">
          <h2 className="text-lg font-bold tracking-wider">{DOCUMENT_TITLES[document.type]}</h2>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8 py-4 border-b border-gray-200">
          <div className="space-y-1 text-sm">
            ...
            <div className="flex"><span className="w-32 text-gray-500">{DUE_DATE_LABELS[document.type]}:</span><span className="text-gray-900">{document.dueDate}</span></div>
          </div>
          <div className="space-y-1 text-sm">
        ...
        <div className="grid grid-cols-2 gap-8 py-4 border-b border-gray-200">
          <div>
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Billed By</h3>
